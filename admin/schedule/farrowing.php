...
if ($notificationId) {
    $notificationData = $notificationController->getFarrowingNotificationById($notificationId);
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php if ($notificationData): ?>
                                                <tr>
                                                    <td><?= htmlspecialchars($notificationData['penno']); ?></td>
                                                    <td><?= htmlspecialchars($notificationData['ear_tag_number']); ?></td>
                                                    <td><?= htmlspecialchars($notificationData['breeding_date']); ?></td>
                                                    <td><?= htmlspecialchars($notificationData['expected_farrowing_date']); ?></td>
                                                    <td><?= htmlspecialchars($notificationData['actual_farrowing_date']); ?></td>
                                                    <td><?= htmlspecialchars($notificationData['sire']); ?></td>
                                                    <td><?= htmlspecialchars($notificationData['pregnancy_status']); ?></td>
                                                    <td><?= htmlspecialchars($notificationData['health_status']); ?></td>
                                                    <td><?= htmlspecialchars($notificationData['litter_size']); ?></td>
                                                    <td><?= htmlspecialchars($notificationData['notes']); ?></td>
                                                    <td>
