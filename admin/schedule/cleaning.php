...
if ($notificationId) {
    $notificationData = $notificationController->getCleaningNotificationById($notificationId);
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php if ($notificationData): ?>
                                                <tr>
                                                    <td><?= htmlspecialchars($notificationData['cleaning_frequency']); ?></td>
                                                    <td><?= formatTime($notificationData['morning_cleaning_time']); ?></td>
                                                    <td><?= formatTime($notificationData['noon_cleaning_time']); ?></td>
                                                    <td><?= formatTime($notificationData['evening_cleaning_time']); ?></td>
                                                </tr>
                                            <?php else: ?>
                                                <tr>
