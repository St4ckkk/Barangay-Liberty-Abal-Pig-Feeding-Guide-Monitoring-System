...
if ($notificationId) {
    $notificationData = $notificationController->getSlaughteringNotificationById($notificationId);
                                        ...
                                        <tbody>
                                            <?php if ($notificationData): ?>
                                                <tr>
                                                    ...
                                                    <td><?= htmlspecialchars($notificationData['slaughtering_date']); ?></td>
                                                    <td><?= formatTime($notificationData['slaughtering_time']); ?></td>
                                                    <td><?= htmlspecialchars($notificationData['status']); ?></td>
                                                    <td>
