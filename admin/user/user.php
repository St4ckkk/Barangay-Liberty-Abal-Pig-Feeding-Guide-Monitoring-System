                                            ...
                                            <?php if (!empty($users)) : ?>
                                                <?php foreach ($users as $user) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <!-- Trigger Modals -->
                                                            <button class="btn btn-primary" onclick="editUser('<?php echo $user['userId']; ?>', '<?php echo htmlspecialchars($user['username']); ?>', '<?php echo htmlspecialchars($user['status']); ?>','<?php echo htmlspecialchars($user['role']); ?>')">
                                                                <i class="bi bi-pencil"></i>
                                                            </button>
                                                            <button class="btn btn-danger" onclick="deleteUser('<?php echo $user['userId']; ?>')">
